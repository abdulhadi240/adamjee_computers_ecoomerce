...
function Header() {
  ...
  const createClerkPasskey = async () => { try {
      ...
      <div className="flex w-full justify-between items-center">
        ...
        <div className="flex items-center space-x-4 mt-4 sm:mt-0 flex-1 sm:flex-none">
          ...
          >
            ...
            <span className="absolute -top-2 -right-2 bg-red-500 text-white rounded-full w-5 h-5 flex
            items-center justify-center text-xs"> {itemCount}</span>
            <span>My Basket</span>
          </Link>
          {/* User area */}
<ClerkLoaded>
